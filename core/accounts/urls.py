...
from .views import (
    AccountsLoginView,
    AccountsLogoutView,
    AccountsRegisterFormView,
    AccountsPasswordChangeView,
    AccountsPasswordChangeDoneView,
    AccountsActivationEmailSendTemplateView,
    AccountActivationEmailResendFormView,
...
urlpatterns = [
    ...
    path(
        ...
        AccountActivationConfirmTemplateView.as_view(),
        name="activation_confirm",
    ),
    path(
        "activation/send/",
        AccountsActivationEmailSendTemplateView.as_view(),
        name="activation_send",
    ),
    path(
        "activation/resend/",
        AccountActivationEmailResendFormView.as_view(),
    ...
    path(
        ...
        AccountsPasswordChangeDoneView.as_view(),
